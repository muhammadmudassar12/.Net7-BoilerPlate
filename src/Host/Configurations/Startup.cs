namespace EMS20.WebApi.Host.Configurations;
...
internal static class Startup
{
    internal static WebApplicationBuilder AddConfigurations(this WebApplicationBuilder builder)
    {
        ...
        builder.Configuration.AddJsonFile("appsettings.json", optional: false, reloadOnChange: true)
                ...
                .AddJsonFile($"{configurationsDirectory}/pushnotification.json", optional: false, reloadOnChange: true)
                .AddJsonFile($"{configurationsDirectory}/pushnotification.{env.EnvironmentName}.json", optional: true, reloadOnChange: true)
